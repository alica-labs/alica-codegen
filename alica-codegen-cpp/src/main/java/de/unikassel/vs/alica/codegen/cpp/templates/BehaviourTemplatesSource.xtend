...
namespace alica {
    «StringUtils.capitalize(behaviour.name)»::«StringUtils.capitalize(behaviour.name)»(void* context): DomainBehaviour("«behaviour.name»", «behaviour.id», context) {
        this -> impl = std::make_shared<«StringUtils.capitalize(behaviour.name)»Impl>(std::shared_ptr<DomainBehaviour>(this));
    }
...
namespace alica {
    «StringUtils.capitalize(behaviour.name)»Impl::«StringUtils.capitalize(behaviour.name)»Impl(std::shared_ptr<DomainBehaviour> domain): DomainBehaviourImpl(domain) {
